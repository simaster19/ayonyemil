       ...
       <div class="container py-5">
         <div class="row g-5">
           ...
           <div class="col-lg-4 col-md-6">
             ...
             <div class="d-flex pt-2">
               <a class="btn btn-outline-light btn-social" href=""
                 ><img src="../assets/frontend/img/instagram.svg" alt=""
               /></a>
               <a class="btn btn-outline-light btn-social" href=""
                 ><img src="../assets/frontend/img/tiktok.svg" alt=""
               /></a>
             </div>
           </div>
           <div class="col-lg-4 col-md-6">
           ...
           <div class="col-lg-4 col-md-6">
             ...
             <p>
               Anda akan mendapatkan notifikasi jika ada update produk, Subscribe
               me
             </p>

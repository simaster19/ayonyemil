          ...
          <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-start">
              <h1 class="display-3 text-white animated slideInLeft">
                Nyemil Enak<br />Murah dan Sehat
              </h1>
              <p class="text-white animated slideInLeft mb-4 pb-2">
                Aneka cemilan dan jajanan masa kini, cocok untuk kalian yang
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="service-item rounded pt-3">
                <div class="p-4">
                  ...
                  <p>
                    Ada berbagai pilihan cemilan untuk kamu penikmat cemilan
                    ringan.
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="service-item rounded pt-3">
                <div class="p-4">
                  ...
                  <p>
                    Daftar akun terlebih dahulu untuk membeli cmilan secara
                    online.
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
              <div class="service-item rounded pt-3">
                <div class="p-4">
                  ...
                  <p>Respon cepat hanya pada jam kerja dan hari Senin - Jumat.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        <div class="container">
          <div class="text-center">
            ...
            <h1 class="mb-5">Beberapa Customer Berkata!</h1>
          </div>

          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item text-center rounded overflow-hidden">
              <div class="rounded-circle overflow-hidden m-4">
                ...
                Storage::url('assets/images/product/'.$product->foto_produk) }}" alt="">
              </div>
              ...
              <div class="d-flex justify-content-center mt-3">
                <a class="btn btn-square btn-primary mx-1"
                  ...
                  href="" onclick="event.preventDefault()"><i
                    class="bi-eye-fill"></i></a>

                <a class="btn btn-square btn-primary mx-1"
                  href="shopee.co.id/miftakhulmcu"><i
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="col-12 d-flex justify-content-center mb-2">
                        ...
                        src="{{ Storage::url('images/product/' .
                        $product->foto_produk) }}"
                        alt="Foto Produk"

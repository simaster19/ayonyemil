    ...
    <div class="container-xxl position-relative p-0">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
        <a href="" class="navbar-brand p-0">
          <h1 class="text-primary m-0"><img src="{{url('assets/img/logo.png')}}" width="60px" height="60px" alt=""> Ayo Nyemil!</h1>
        ...
        <div class="container my-5 py-5">
          <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-start">
              ...
              <a href="" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Beli Sekarang!</a>
            </div>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item text-center rounded overflow-hidden">
              ...
              <div class="d-flex justify-content-center mt-3">
                <a class="btn btn-square btn-primary mx-1" href=""><i class="bi bi-cart-plus-fill"></i></a>
                <a class="btn btn-square btn-primary mx-1" href=""><i
                class="bi-instagram"></i></a>
                <a class="btn btn-square btn-primary mx-1" href=""><i class="bi
                bi-whatsapp"></i></a>
